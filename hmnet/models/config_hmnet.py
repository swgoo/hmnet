...
class HMNetConfig:
    ...
    d_intermediate: List[int] = field(default_factory=list) # intermediate dimension for the FFNs (0 indicates no FFN)
    n_chunk_select: List[int] = field(default_factory=list)
    vocab_size: int = 256
