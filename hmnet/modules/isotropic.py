...
# TODO : Add FlexAttn support for Isotropic
class Isotropic(nn.Module):
    ...
    def step(self, hidden_states, inference_params, **mixer_kwargs):
        """
        ...
        for layer in self.layers:
            hidden_states, residual = layer.step(
                hidden_states, inference_params, residual=residual, **mixer_kwargs
            )
